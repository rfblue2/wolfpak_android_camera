	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if(widthMode == MeasureSpec.EXACTLY || heightMode == MeasureSpec.EXACTLY) {
			...
			if(widthMode == MeasureSpec.EXACTLY && heightMode != MeasureSpec.EXACTLY) {
				...
				int h = (int) (widthAllowed - mHuePanelWidthPx);
				...
				int w = (int) (heightAllowed + mHuePanelWidthPx);
			...
			int widthNeeded = (int) (heightAllowed + mHuePanelWidthPx);
			
			//Calculate the needed height to layout using max allowed width.
			int heightNeeded = (int) (widthAllowed - mHuePanelWidthPx);
